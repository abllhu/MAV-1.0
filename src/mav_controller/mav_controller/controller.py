...
class Controller(Node):
    ...
    def __init__(self):
        ...
        self.vel_sub_ = self.create_subscription(TwistStamped, "mav_controller/cmd_vel", self.velCallback, 10)

        # Subscribe in the simuulated encoder readings for the wheels
        self.joint_sub_ = self.create_subscription(JointState, "joint_states", self.jointcallback, 10)

        self.odom_pub_ = self.create_publisher(Odometry, "mav_controller/odom", 10)
